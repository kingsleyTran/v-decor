...
if (class_exists('WooCommerce')) {
	...
	function woocommerce_getbowtied_product_cat_header_columns( $columns ) {
	...
	add_filter( 'manage_edit-product_cat_columns', 'woocommerce_getbowtied_product_cat_header_columns' );
	...
	function woocommerce_getbowtied_product_cat_header_column( $columns, $column, $id ) {
	...
	add_filter( 'manage_product_cat_custom_column', 'woocommerce_getbowtied_product_cat_header_column', 10, 3 );
	...
	/**
	 * getbowtied_woocommerce_get_header_image_url function.
	 *
	 * @access public
	...
	function getbowtied_woocommerce_get_header_image_url($cat_ID = false) {
	...
	add_action('woocommerce_archive_description','getbowtied_show_category_header');
	function getbowtied_show_category_header() {
		$category_header_src = getbowtied_woocommerce_get_header_image_url();	
	...
	function getbowtied_product_cat_header_column() {
	...
	add_action('admin_head', 'getbowtied_product_cat_header_column');
