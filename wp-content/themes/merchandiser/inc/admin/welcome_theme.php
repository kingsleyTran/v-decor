		...
		if ( !is_plugin_active('getbowtied-tools/getbowtied-tools.php') ): ?>
			<div class="inner">
				...
				<?php 
					...
					echo $actions['button'];
				?>
				<br/><a href="http://merchandiser-help.getbowtied.com/hc/en-us/articles/212408525"  target="_blank" class="video-guide"><span class="dashicons dashicons-video-alt3"></span> <?php echo __("Installation & Setup <span class='dashicons dashicons-minus'></span> Video Guide"); ?></a>
