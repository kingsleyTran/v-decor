...
add_action( 'add_meta_boxes', 'getbowtied_product_options_meta_box_add' );

function getbowtied_product_options_meta_box_add()
{
    add_meta_box( 'product_options_meta_box', 'Product Options', 'getbowtied_product_options_meta_box_content', 'product', 'side', 'high' );
}

function getbowtied_product_options_meta_box_content()
{
...
add_action( 'save_post', 'getbowtied_product_options_meta_box_save' );

function getbowtied_product_options_meta_box_save($post_id)
{
