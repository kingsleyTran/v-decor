...
function getbowtied_shortcode_recent_products_mixed($atts, $content = null) {
    ...
    if ($layout == "masonry") {
		echo do_shortcode('[recent_products_list gutter="'.$gutter.'" per_page="'.$per_page.'" columns="'.$columns.'" orderby="'.$orderby.'" order="'.$order.'"]');
	} else {
...
add_shortcode("recent_products_mixed", "getbowtied_shortcode_recent_products_mixed");