...
function getbowtied_shortcode_product_attribute_mixed($atts, $content = null) {
...
add_shortcode("product_attribute_mixed", "getbowtied_shortcode_product_attribute_mixed");